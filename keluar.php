...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.php" style="align-items: center; display: flex;">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    $ambilstok = mysqli_query($conn, "SELECT * FROM tb_keluar m, tb_stok s WHERE s.idbrg = m.idbrg");
                                    $i = 1;
                ...
                <div class="modal-body">
                    <select name="barang" class="form-control">
                        ...
                        while ($fetcharray = mysqli_fetch_array($ambildata)) {
                            $idbrg = $fetcharray['idbrg'];
                            $namabrg = $fetcharray['namabrg'];
                        ?>

                            <option value="<?= $idbrg; ?>"><?= $namabrg; ?></option>
                        <?php
                        }
                        ?>
                    </select>
